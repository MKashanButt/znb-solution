<x-app-layout>
                ...
                <div class="flex flex-col gap-8 order-2 lg:order-1">
                    ...
                    <div class="flex flex-col gap-6">
                        <h1
                            ...
                            Revenue Cycle That <span class="text-primary">Actually Pays</span>.
                        </h1>

                        <p class="text-slate-600 dark:text-slate-400 text-lg md:text-xl leading-relaxed max-w-xl">
                            Reduce denials, accelerate collections, and gain full visibility into claims — with a clean
                            billing workflow
                    ...
                    <div class="flex items-center gap-4 pt-4">
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400 font-medium">
                            Trusted by <span class="text-navy-text dark:text-white font-bold">billing teams</span> that
                            hate denials.
                        </p>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-20">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-4 text-center md:text-left">
                        ...
                        <div>
                            <h3 class="text-navy-text dark:text-white font-bold text-sm">Claims Processing</h3>
                            <p class="text-slate-500 text-xs mt-1">Cleaner submissions, fewer reworks</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-4 text-center md:text-left">
                        ...
                        <div>
                            <h3 class="text-navy-text dark:text-white font-bold text-sm">Denial Prevention</h3>
                            <p class="text-slate-500 text-xs mt-1">Catch issues before payers do</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-4 text-center md:text-left">
                        ...
                        <div>
                            <h3 class="text-navy-text dark:text-white font-bold text-sm">Revenue Visibility</h3>
                            <p class="text-slate-500 text-xs mt-1">Track AR, aging, & performance</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-4 text-center md:text-left">
                        ...
                        <div>
                            <h3 class="text-navy-text dark:text-white font-bold text-sm">Compliance Ready</h3>
                            <p class="text-slate-500 text-xs mt-1">Audit-friendly billing workflows</p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16 space-y-4">
                <h2
                    ...
                    Billing Shouldn’t Feel Like <br class="hidden md:block" />
                    <span class="text-primary">Fighting a Boss Level</span>
                </h2>
                <p class="text-slate-500 dark:text-slate-400 text-lg">
                    RCM is simple in theory: submit clean claims, get paid, repeat.
                    In reality? Denials, delays, missing docs, and endless follow-ups.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
                ...
                <div
                    ...
                    <ul class="space-y-8 flex-1">
                        <li class="flex gap-4">
                            <span class="material-symbols-outlined text-slate-400 mt-1">receipt</span>
                            <div>
                                <h4 class="font-bold text-navy-text dark:text-white text-lg">Dirty claims</h4>
                        ...
                        <li class="flex gap-4">
                            <span class="material-symbols-outlined text-slate-400 mt-1">hourglass_empty</span>
                            <div>
                                <h4 class="font-bold text-navy-text dark:text-white text-lg">Slow reimbursements</h4>
                                <p class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mt-1">
                        ...
                        <li class="flex gap-4">
                            <span class="material-symbols-outlined text-slate-400 mt-1">cancel</span>
                            <div>
                                <h4 class="font-bold text-navy-text dark:text-white text-lg">Denials everywhere</h4>
                                <p class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mt-1">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3 mb-10 relative">
                        ...
                        <h3 class="text-2xl font-bold text-navy-text dark:text-white">Our RCM System</h3>
                    </div>
                    ...
                    <ul class="space-y-8 flex-1 relative">
                        ...
                        <li class="flex gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-navy-text dark:text-white text-lg">Pre-submission validation
                                </h4>
                        ...
                        <li class="flex gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-navy-text dark:text-white text-lg">Faster claim cycles</h4>
                                <p class="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mt-1">
                        ...
                        <li class="flex gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-navy-text dark:text-white text-lg">Real-time revenue
                                    visibility</h4>
                                <p class="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mt-1">
                    ...
                    <div class="mt-12 pt-8 border-t border-primary/10 relative">
                        <div class="flex items-center justify-between">
                            <span class="text-primary font-bold text-sm tracking-wide uppercase">
                                Outcome: higher collections, fewer denials
                            </span>
    ...
    <!-- RCM Workflow Steps -->
    <main class="flex-1 flex flex-col items-center py-16 px-4" id="rcm-workflow">
        ...
        <div class="max-w-[1100px] w-full grid grid-cols-1 md:grid-cols-3 gap-6 p-4">
            ...
            <div
                ...
                <div class="flex flex-col gap-2 relative z-10">
                    <h2 class="text-[#0e131b] dark:text-white text-xl font-bold leading-tight">Eligibility & Benefits
                    </h2>
            ...
            <div
                ...
                <div class="flex flex-col gap-2 relative z-10">
                    <h2 class="text-[#0e131b] dark:text-white text-xl font-bold leading-tight">Claim Submission</h2>
                    <p class="text-[#4e6d97] dark:text-slate-400 text-sm md:text-base font-normal leading-relaxed">
            ...
            <div
                ...
                <div class="flex flex-col gap-2 relative z-10">
                    <h2 class="text-[#0e131b] dark:text-white text-xl font-bold leading-tight">Payment & Collections
                    </h2>
                    <p class="text-[#4e6d97] dark:text-slate-400 text-sm md:text-base font-normal leading-relaxed">
